...
# trSet = ngsimDataset('data/TrainSet-us1011-gan-smooth-nei3&4-nsl.mat')
trSet = ngsimDataset('data/TrainSet-us1011-i801-highd20-inter5d-us1012-gan-pos-nsl.mat')

# valSet = ngsimDataset('data/ValSet-us1011-gan-smooth-nei3&4-nsl.mat')
valSet = ngsimDataset('data/ValSet-us1011-i801-highd20-inter5d-us1012-gan-pos-nsl.mat')
...
for epoch_num in range(trainEpochs):
    ...
    if avg_val_loss < best_val_loss or epoch_num == 0:
        ...
        torch.save(net.state_dict(), 'trained_models/cslstm_us1011_i801_highd20_inter5d_us1012_bestval.tar')
        print("Best val loss updated! current best val loss is at epoch: ", epoch_num + 1)
   

torch.save(net.state_dict(), 'trained_models/cslstm_us1011_i801_highd20_inter5d_us1012.tar')
