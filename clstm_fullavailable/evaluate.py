...
# Initialize network
net = highwayNet(args)
net.load_state_dict(torch.load('trained_models/cslstm_us1011_i801_highd20_inter5d_us1012_bestval.tar'))
if args['use_cuda']:
    net = net.cuda()
...
tsSet = ngsimDataset(test_data,in_test=True)
