...
# gen_set_name = None
# args_g['neigh_num'] = 6
real_set_name = '../data/TrainSet-us1011-gan-smooth-nei3&4-nsl.mat'
...
for start_epoch in range(start_epoch,trainEpochs):
    ...
    for i, data in enumerate(trDataloader):
        ...
        print(compute_grad2(logit_real, real_scene))
        g_loss_reg.backward()
        optimizer.step()
        ...
        if i%sample_interval==0:
            ...
            for draw in range(draw_num):
                ...
                for j in current_id:
                    plt.plot(sample[j,0,:],sample[j,1,:])
    ...
    if start_epoch%3==0 and start_epoch<trainEpochs:
        ...
        torch.save(net_g.state_dict(),
                   'trained_models/generator_us1011_nsl_epoch' + str(start_epoch) + '.tar')
...
torch.save(net_g.state_dict(), 'trained_models/generator_us1011.tar')
torch.save(net_d.state_dict(), 'trained_models/discriminator_us1011.tar')
torch.save(net.state_dict(), 'trained_models/regression_us1011.tar')
