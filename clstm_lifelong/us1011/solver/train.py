...
model_name = 'trained_models/generator_us1011_nsl_hd_epoch102.tar'
...
valSet = ngsimDataset('../data/ValSet-us1011-gan-smooth-nei3&4-nsl.mat',grid_size=args['grid_size'], enc_size=enc_size)
...
for epoch_num in range(pretrainEpochs):
    ...
    if avg_val_loss < best_val_loss or epoch_num == 0:
        ...
        torch.save(net.state_dict(), 'trained_models/cslstm_us1011_nei3&4_nsl_bestval_5hz_sgan102.tar')
        print("Best val loss updated! current best val loss is at epoch: ", epoch_num + 1)

print('best val loss is: ',best_val_loss/val_batch_count)
