...
model_name = 'trained_models/generator_us1011_i801_nsl_epoch402.tar'
...
valSet = ngsimDatasetGan('../data/ValSet-i801-gan-smooth-nei3&4.mat', enc_size=256,
                        batch_size=args_g['batch_size'], 
                        local_normalise=1)
...
for epoch_num in range(pretrainEpochs):
    ...
    if avg_val_loss < best_val_loss or epoch_num == 0:
        ...
        torch.save(net.state_dict(), 'trained_models/cslstm_us1011_i801_bestval_sgan402_i801cond.tar')
