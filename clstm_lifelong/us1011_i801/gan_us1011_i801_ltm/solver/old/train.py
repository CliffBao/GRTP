...
model_name = 'trained_models/generator_us1011_i801_epoch300.tar'
...
valSet = ngsimDataset('../data/ValSet-us1011-gan-smooth-nei3&4.mat',grid_size=args['grid_size'], enc_size=enc_size)
# valSet = ngsimDataset('../data/ValSet-i801-gan-smooth-nei3&4.mat',grid_size=args['grid_size'], enc_size=enc_size)
...
for epoch_num in range(pretrainEpochs):
    ...
    if avg_val_loss < best_val_loss or epoch_num == 0:
        ...
        torch.save(net.state_dict(), 'trained_models/cslstm_us1011_i801_onus1011_bestval_sgan300.tar')
