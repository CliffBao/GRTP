...
# Initialize network
net = highwayNet(args)
net.load_state_dict(torch.load('trained_models/cslstm_us1011_i801_onus1011_bestval_sgan201.tar'))
...
tsSet = ngsimDataset('../data/TestSet-i801-gan-smooth-nei3&4.mat')
