...
for start_epoch in range(start_epoch,trainEpochs):
    ...
    if start_epoch%3==0 and start_epoch<trainEpochs:
        ...
        torch.save(net_g.state_dict(),
                   'trained_models/generator_us1012_epoch' + str(start_epoch) + '.tar')
...
torch.save(net_g.state_dict(), 'trained_models/generator_us1012.tar')
torch.save(net_d.state_dict(), 'trained_models/discriminator_us1012.tar')
torch.save(net.state_dict(), 'trained_models/regression_us1012.tar')
