...
model_name = 'trained_models/generator_us1012_epoch702.tar'
...
valSet = ngsimDataset('../data/ValSet-us1012-gan-smooth-nei3&4-nsl.mat',grid_size=args['grid_size'], enc_size=enc_size)
...
for epoch_num in range(pretrainEpochs):
    ...
    if avg_val_loss < best_val_loss or epoch_num == 0:
        ...
        torch.save(net.state_dict(), 'trained_models/cslstm_us1012_bestval_sgan702.tar')
