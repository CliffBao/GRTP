...
# Initialize network
net = highwayNet(args)
net.load_state_dict(torch.load('trained_models/cslstm_us1011_i801_highd20p_inter5d_us1012_bestval_sgan501_us1012cond.tar'))
# net.load_state_dict(torch.load('trained_models/cslstm_ngsim_nei4_besttr.tar'))
if args['use_cuda']:
    net = net.cuda()
tsSet_name = '../data/TestSet-us1011-gan-smooth-nei3&4-nsl.mat'
# tsSet_name = '../data/TestSet-i801-gan-smooth-nei3&4-nsl.mat'
# tsSet_name = '../data/TestSet-highd20-gan-pos-nsl.mat'
# tsSet_name = '../data/TestSet-inter5d-gan-lane-clustered.mat'
# tsSet_name = '../data/TestSet-us1012-gan-smooth-nei3&4-nsl.mat'
...
for i, data in enumerate(tsDataloader):
    ...
    counts += c.detach()
unit_scale = 0.3048
if 'highd' in tsSet_name or 'inter' in tsSet_name:
    unit_scale = 1.0
if metric == 'nll':
    print(lossVals / counts)
else:
    print(torch.pow(lossVals / counts,0.5)*unit_scale)   # Calculate RMSE and convert from feet to meters
