...
# gen_set_name = None
# args_g['neigh_num'] = 6
real_set_name = 'data/TrainSet-us1012-gan-smooth-nei3&4-nsl.mat'
...
net = highwayNet(args)
net_g_us1011_i801_highd20p_inter5d = highwayNet_g_compose(args_g_trained)
net_g_us1012 = highwayNet_g_compose(args_g_trained)

# we can start from last saved models
net_g_us1011_i801_highd20p_inter5d.load_state_dict(torch.load('trained_models/generator_us1011_i801_highd20p_inter5d_epoch201.tar'))
net_g_us1012.load_state_dict(torch.load('trained_models/generator_us1012_epoch402.tar'))

if args_d['use_cuda']:
    net_d = net_d.cuda()
    net_g = net_g.cuda()
    net = net.cuda()
    net_g_us1011_i801_highd20p_inter5d = net_g_us1011_i801_highd20p_inter5d.cuda()
    net_g_us1012 = net_g_us1012.cuda()
...
for start_epoch in range(start_epoch,trainEpochs):
    ...
    for i, data in enumerate(trDataloader):
        ...
        st_time = time.time()
        _,_,_,mask,index_division,maneuver,scale = data
        ...
        with torch.no_grad():
            ...
            scene_us1011_i801_highd20p_inter5d = net_g_us1011_i801_highd20p_inter5d(pos_condition,index_division)
            scene_us1012 = net_g_us1012(pos_condition,index_division)
            real_scene = torch.cat((scene_us1011_i801_highd20p_inter5d,scene_us1012),axis=0)
        ...
        if i%sample_interval==0:
            ...
            for draw in range(draw_num):
                ...
                chosen_ones.append(chose_one)
                current_id = index_division_plot[chose_one]
                hero_id = hero_pos_index[chose_one]
    ...
    if start_epoch%3==0 and start_epoch<trainEpochs:
        ...
        torch.save(net_g.state_dict(),
                   'trained_models/generator_us1011_i801_highd20p_inter5d_us1012_epoch' + str(start_epoch) + '.tar')
...
torch.save(net_g.state_dict(), 'trained_models/generator_us1011_i801_highd20p_inter5d_us1012.tar')
torch.save(net_d.state_dict(), 'trained_models/discriminator_us1011_i801_highd20p_inter5d_us1012.tar')
torch.save(net.state_dict(), 'trained_models/regression_us1011_i801_highd20p_inter5d_us1012.tar')
