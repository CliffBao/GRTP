...
net_g_us1011_i801_highd20p.load_state_dict(torch.load('trained_models/generator_us1011_i801_highd20p_inter5d_epoch300.tar'))
...
for start_epoch in range(start_epoch,trainEpochs):
    ...
    for i, data in enumerate(trDataloader):
        ...
        with torch.no_grad():
            ...
            scene_us1011 = net_g_us1011_i801_highd20p(pos_condition,index_division)
