...
model_name = 'trained_models/generator_us1011_i801_highd20p_inter5d_us1012_epoch702.tar'
...
# valSet = ngsimDatasetGan('../data/ValSet-us1011-gan-smooth-nei3&4.mat',grid_size=args['grid_size'], enc_size=enc_size)
valSet = ngsimDatasetGan('../data/ValSet-us1012-gan-smooth-nei3&4-nsl.mat', enc_size=256,
                        batch_size=args_g['batch_size'], 
                        local_normalise=1)
...
valDataloader = DataLoader(valSet,batch_size=batch_size,shuffle=True,num_workers=4,drop_last = True,collate_fn=valSet.collate_fn)
...
for epoch_num in range(pretrainEpochs):
    ...
    if avg_val_loss < best_val_loss or epoch_num == 0:
        ...
        torch.save(net.state_dict(), 'trained_models/cslstm_us1011_i801_highd20p_inter5d_us1012_bestval_sgan702_us1012cond.tar')
        # torch.save(net.state_dict(), 'trained_models/cslstm_us1011_i801_oni801_bestval_sgan201.tar')
