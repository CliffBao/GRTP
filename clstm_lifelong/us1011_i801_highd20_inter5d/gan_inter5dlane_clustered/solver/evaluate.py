...
# Initialize network
net = highwayNet(args)
net.load_state_dict(torch.load('trained_models/cslstm_inter5dlane_clustered_bestval_sgan300.tar'))
if args['use_cuda']:
    net = net.cuda()

tsSet = ngsimDataset('../data/TestSet-inter5d-gan-lane-clustered.mat')
...
if metric == 'nll':
    ...
    print(torch.pow(lossVals / counts,0.5)*1.0)   # Calculate RMSE and convert from feet to meters
