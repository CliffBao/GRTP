...
model_name = 'trained_models/generator_inter5dlane_clustered_epoch300.tar'
...
valSet = ngsimDataset('../data/ValSet-inter5d-gan-lane-clustered.mat',grid_size=args['grid_size'], enc_size=enc_size)
...
for epoch_num in range(pretrainEpochs):
    ...
    if avg_val_loss < best_val_loss or epoch_num == 0:
        ...
        torch.save(net.state_dict(), 'trained_models/cslstm_inter5dlane_clustered_bestval_sgan300.tar')
        print("Best val loss updated! current best val loss is at epoch: ", epoch_num + 1) #__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
