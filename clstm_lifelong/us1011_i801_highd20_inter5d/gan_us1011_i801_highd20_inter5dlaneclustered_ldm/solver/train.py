...
model_name = 'trained_models/generator_us1011_i801_highd20p_inter5d_epoch600.tar'
...
# real_set_name = '../data/TrainSet-us1011-gan-smooth-nei3&4.mat'
...
valSet = ngsimDatasetGan('../data/ValSet-inter5d-gan-lane-clustered.mat', enc_size=256,
                        batch_size=args_g['batch_size'], 
                        local_normalise=1)
...
for epoch_num in range(pretrainEpochs):
    ...
    if avg_val_loss < best_val_loss or epoch_num == 0:
        ...
        torch.save(net.state_dict(), 'trained_models/cslstm_us1011_i801_highd20p_inter5d_bestval_sgan600_5dpcond.tar')
