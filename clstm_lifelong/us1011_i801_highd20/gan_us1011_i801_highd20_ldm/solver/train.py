...
model_name = 'trained_models/generator_us1011_i801_highd20p_nsl_epoch702.tar'
...
valSet = ngsimDatasetGan('../data/ValSet-highd20-gan-pos-nsl.mat', enc_size=256,
                        batch_size=args_g['batch_size'], 
                        local_normalise=1)
...
for epoch_num in range(pretrainEpochs):
    ...
    if avg_val_loss < best_val_loss or epoch_num == 0:
        ...
        torch.save(net.state_dict(), 'trained_models/cslstm_us1011_i801_highd20p_bestval_sgan702_20pcond.tar')
