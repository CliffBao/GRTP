...
class ngsimDataset(Dataset):
    ...
    def __init__(self, mat_file, t_h=75, t_f=125, d_s=5, neigh_num=-1, enc_size=64, grid_size=(13, 3), hero_grid_pos=19,
                 length=200, use_cuda=True, local_normalise=0, batch_size=512, cond_length=0):
    ...
    def getHistoryEM(self, vehId, t, dsId):
        ...
        if row_num < self.length // self.d_s+1:
            print('Warning: row num is not enough!!!',vehId,t,dsId,'-',stpt,'-',enpt,'-',len(vehTrack))
