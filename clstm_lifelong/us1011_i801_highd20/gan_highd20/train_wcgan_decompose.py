...
# gen_set_name = None
# args_g['neigh_num'] = 6
real_set_name = 'data/TrainSet-highd20-gan-pos-nsl.mat'
...
for start_epoch in range(start_epoch,trainEpochs):
        ...
        if i%sample_interval==0:
            ...
            for draw in range(draw_num):
                ...
                for j in current_id:
                    ...
                    # plt.text(sample[j,0,-1],sample[j,1,-1],pos_condition[j,:].detach().cpu().numpy())
    ...
    if start_epoch%3==0 and start_epoch<trainEpochs:
        ...
        torch.save(net_g.state_dict(),
                   'trained_models/generator_highd20p_nsl_epoch' + str(start_epoch) + '.tar')
...
torch.save(net_g.state_dict(), 'trained_models/generator_highd20p_nsl.tar')
torch.save(net_d.state_dict(), 'trained_models/discriminator_highd20p_nsl.tar')
torch.save(net.state_dict(), 'trained_models/regression_highd20p_nsl.tar')
